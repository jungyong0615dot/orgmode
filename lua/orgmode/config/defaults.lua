...
local DefaultConfig = {
  ...
  mappings = {
    ...
    agenda = {
      ...
      org_agenda_redo = 'r',
      org_agenda_todo = 'T',
      org_agenda_clock_goto = 'C',
      org_agenda_set_effort = 'E',
      org_agenda_clock_in = '<S-Up>',
      org_agenda_clock_out = '<S-Down>',
    ...
    org = {
      ...
      org_archive_subtree = 'D',
      -- org_set_tags_command = '<prefix>t',
      org_set_tags_command = 'Y',
      ...
      org_return = '<CR>',
      org_insert_heading_respect_content = 'H', -- Add new heading after current heading block (same level)
      org_insert_todo_heading = '<prefix>iT', -- Add new todo heading right after current heading (same level)
      org_insert_todo_heading_respect_content = 'P', -- Add new todo heading after current heading block (same level)
